    ...
    <div class="container section-pad-sm">
        ...
        <table class="table table-hover" style="table-layout:fixed;">
            ...
            <tbody>
                <c:if test="${ar == null}">
                    <tr>
                        <td colspan="6" style="color:#8b949e;">검색 결과가 없습니다.</td>
                    </tr>
                </c:if>
                <c:forEach var="vo" items="${ar}" varStatus="st">
                    <tr>
                        ...
                        <td style="word-break: break-all; text-overflow:unset; overflow:unset; white-space:unset;">
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="flush-heading${vo.b_idx}">
                                    <button class="accordion-button collapsed" style="overflow:hidden; text-overflow:ellipsis; white-space:nowrap;" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse${vo.b_idx}" aria-expanded="false" aria-controls="flush-collapse${vo.b_idx}">
                                        ${vo.b_content}
                                    </button>
                                </h2>
                        ...
                        <td>
                            <c:if test="${vo.b_score == 0}"><span class="star-empty">☆☆☆☆☆</span></c:if>
                            <c:if test="${vo.b_score == 1}"><span class="star-filled">★</span><span class="star-empty">☆☆☆☆</span></c:if>
                            <c:if test="${vo.b_score == 2}"><span class="star-filled">★★</span><span class="star-empty">☆☆☆</span></c:if>
                            <c:if test="${vo.b_score == 3}"><span class="star-filled">★★★</span><span class="star-empty">☆☆</span></c:if>
                            <c:if test="${vo.b_score == 4}"><span class="star-filled">★★★★</span><span class="star-empty">☆</span></c:if>
                            <c:if test="${vo.b_score == 5}"><span class="star-filled">★★★★★</span></c:if>
                        </td>
